#!/usr/bin/env python3
"""Create evidence JSON records for every resampled sensor CSV in a directory."""
...
def main() -> int:
    ...
    for index, csv_path in enumerate(csv_paths, start=1):
        ...
        output_path.write_text(json.dumps(predict_recording(csv_path, saved_model), indent=2) + "\n", encoding="utf-8")
        written += 1
